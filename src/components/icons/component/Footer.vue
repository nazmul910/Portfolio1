<script setup>
  ...
  <template>
    <footer class="px-4 divide-y bg-secendary ">
      <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div class="lg:w-1/3">
          <a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
            ...
            <span class="self-center text-2xl font-semibold text-white">Nazmul</span>
          </a>
        </div>
        <div class="grid grid-cols-2 text-sm md:text-xl text-tsecendary md:font-thin gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div class="space-y-3">
      ...
      <div class="py-6 text-sm text-center dark:text-gray-600 ankor text-white">© 2025 All rights reserved.</div>
    </footer>
  </template>
